...
const geocoder = document.querySelector(".cesium-viewer-geocoderContainer");
const projection = document.querySelector(".cesium-sceneModePicker-wrapper");

if (geocoder) {
  geocoder.style.position = "absolute";
  geocoder.style.top = "20px";
  geocoder.style.right = "20px";
}

if (projection) {
  projection.style.position = "absolute";
  projection.style.top = "60px"; // lower to avoid overlap
  projection.style.right = "20px";
}
